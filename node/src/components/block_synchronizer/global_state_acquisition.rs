...
/*
have this as an enum to avoid the option in BlockAcquisitionState:
Acquiring, Skipped

maybe carry over the GlobalStateAcquisition to the next block if it leaps, or if the root hash is the same
*/
